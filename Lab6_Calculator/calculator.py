...
class Calculator(QWidget):
    def __init__(self):
        ...
        # Горизонтальные оси выравнивания - главные
        ...
        # Вертикальные оси выравнивания вторичные, их привязываем к горизонтальным
    ...
    def erro(self, err_number):
        err = QMessageBox()
        if err_number == 1:
            err.setText('Enter correct value')
            self.input.setText("")
        elif err_number == 2:
            err.setText('Division by zero')
            self.input.setText("")
